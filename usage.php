   ...
   <?php
    ...
    <table width="95%" border="1">
      <tr>
        ...
        <th width="209" class="bg1" scope="col">EB No. </th>
        <th width="209" class="bg1" scope="col">Usage</th>
        <th width="209" class="bg1" scope="col">Bill</th>
      </tr>
      <?php
	  $i=0;
	...
	$row1=mysql_fetch_array($qry1);
      ...
      <tr>
        ...
        <td class="bg2"><?php echo $row1['ebno']; ?></td>
        <td class="bg2"><?php echo $row['units']; ?></td>
        <td class="bg2"><a href="bill.php?id=<?php echo $row['id']; ?>">Bill</a></td>
      </tr>
      <?php
	  }
	  ?>
